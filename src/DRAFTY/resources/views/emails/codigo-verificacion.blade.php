...
<head>
    ...
    <title>Código de verificación DRAFTY</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#0f1214;border:1px solid rgba(190,255,72,0.24);border-radius:12px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:30px 26px 10px;">
                            ...
                            <h1 style="margin:0;color:#ffffff;font-size:28px;line-height:1.15;">Verifica tu correo</h1>
                            <p style="margin:16px 0 0;color:#cbd5d1;font-size:16px;line-height:1.6;">Introduce este código en DRAFTY para terminar de crear tu cuenta.</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:0 26px 30px;">
                            <p style="margin:0;padding:14px 16px;border-radius:8px;background:rgba(190,255,72,0.08);color:#dfff9f;font-size:14px;line-height:1.5;">
                                Este código caduca en 10 minutos. Si no has solicitado esta cuenta, puedes ignorar este correo.
                            </p>
                        </td>
                    </tr>
                </table>
